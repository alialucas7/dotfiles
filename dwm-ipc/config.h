...
static const char col_negro[]       = "#191919";
...
static const char *thunare[]   = {"alacritty","-e","ranger",NULL};
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_l,	   spawn,	   {.v = alacritty} },
	{ MODKEY,			XK_c,	   spawn,	   SHCMD("exec ~/.scripts/screenshot") },
